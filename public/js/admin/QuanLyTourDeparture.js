document.addEventListener('DOMContentLoaded', function() {
    ...
    // Modal thêm
    var addModal = document.getElementById('addTourDepartureModal');
    if (addModal) {
        addModal.addEventListener('show.bs.modal', function () {
            ...
            fetch('index.php?controller=TourDeparture&action=getAddForm')
    ...
    // Modal sửa
    var editModal = document.getElementById('editTourDepartureModal');
    if (editModal) {
        editModal.addEventListener('show.bs.modal', function (event) {
            ...
            fetch('index.php?controller=TourDeparture&action=getEditForm&id=' + id)
                .then(response => response.text())
                .then(html => {
                        modalBody.innerHTML = html;
                })
    ...
    // Modal xóa
    var deleteModal = document.getElementById('deleteTourDepartureModal');
    if (deleteModal) {
