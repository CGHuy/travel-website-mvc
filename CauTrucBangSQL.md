...
image LONGBLOB NOT NULL, -- lưu ảnh dung lượng lớn
...
description TEXT DEFAULT NULL, -- mô tả chi tiết
     ...
     FOREIGN KEY (tour_id) REFERENCES tours(id) ON DELETE CASCADE,
     UNIQUE KEY uk_tour_day (tour_id, day_number)   -- mỗi ngày trong mỗi tour chỉ 1 lịch trình
...
status ENUM('open','closed','full') DEFAULT 'open',
     ...
     FOREIGN KEY (tour_id) REFERENCES tours(id) ON DELETE CASCADE,
     UNIQUE KEY uk_tour_date (tour_id, departure_date) -- Mỗi tour chỉ có một khởi hành trong một ngày
...
service_id INT NOT NULL,
     ...
     UNIQUE KEY uk_tour_service (tour_id, service_id)  -- mỗi dịch vụ trong mỗi tour chỉ 1 lần
...
-- Thông tin liên hệ người đặt (trong trường hợp đặt cho người khác)
...
note TEXT DEFAULT NULL,
     ...
     FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE SET NULL, -- Nếu user bị xóa thì giữ lại booking với user_id NULL
